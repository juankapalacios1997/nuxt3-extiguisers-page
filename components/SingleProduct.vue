...
<script setup lang="ts">
    ...
    const props = defineProps({
        product: {
            type: [Object, null] as PropType<ProductType | null>,
            required: true,
        }
    })

    const currentImageUrl = computed(() => new URL(`../assets/images/${(props.product as ProductType).image}`, import.meta.url).href);
</script>
<style scoped>
    .hero-container {
        display: flex;
